#!/bin/bash
# Single-machine 8-GPU SFT for pedia_8b_SFT_v1.
# Dataset: pedia_data/pedia_8b_SFT_v1/
# Model output: pedia_model/pedia_8b_SFT_v1/
#
...
CFG="configs/pedia_8b_SFT_v1.yaml"
LOG_DIR="${SCRIPT_DIR}/logs"
mkdir -p "${LOG_DIR}"
LOG_FILE="${LOG_DIR}/pedia_8b_SFT_v1.$(date '+%Y%m%d_%H%M%S').log"
