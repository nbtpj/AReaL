...
RUN_NAME="dapo-math-qwen3-1.7b-base-reward-lr1e-6-300-steps"
EXPERIMENT_NAME="dapo_math_qwen3_1_7b_base_reward_lr1e_6_300_steps"
...
../.venv/bin/python -m verl.trainer.main_ppo \
  ...
  data.train_files="/storage/openpsi/users/zzy/dapo/data/dapo-math-17k.parquet" \
