...
export VERL_FILE_LOGGER_PATH="${ROOT}/openr1_deepscaler_reward_lr1e-6_metrics.jsonl"
export PYTHONPATH="."
export VLLM_USE_V1=1
export VERL_RUN_TOKEN="openr1-deepscaler-reward-lr1e-6-$(date +%s)"
...
../.venv/bin/python -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name=openr1_fix_reward_lr1e_6_qwen3_1_7b \
  ...
  trainer.default_local_dir="${ROOT}/ckpts/openr1-fix-reward-lr1e-6" \
  trainer.validation_data_dir="${ROOT}/logs/openr1-fix-reward-lr1e-6_validation" \
  trainer.rollout_data_dir="${ROOT}/logs/openr1-fix-reward-lr1e-6_rollout" \
