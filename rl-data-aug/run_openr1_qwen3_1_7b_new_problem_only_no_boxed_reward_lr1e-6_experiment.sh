...
RUN_NAME="openr1-qwen3-1.7b-new-problem-only-no-boxed-reward-lr1e-6"
EXPERIMENT_NAME="openr1_qwen3_1_7b_new_problem_only_no_boxed_reward_lr1e_6"
...
../.venv/bin/python -m verl.trainer.main_ppo \
  ...
  data.train_files="${ROOT}/rl_data_aug/openr1_qwen_problem_only_no_boxed.jsonl" \
