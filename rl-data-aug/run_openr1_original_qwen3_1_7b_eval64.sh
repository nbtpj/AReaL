...
export VERL_FILE_LOGGER_PATH="${ROOT}/openr1-original-qwen3-1.7b-eval64_metrics.jsonl"
export PYTHONPATH="."
export VLLM_USE_V1=1
export VERL_RUN_TOKEN="openr1-original-qwen3-1.7b-eval64-$(date +%s)"
...
../.venv/bin/python -m verl.trainer.main_ppo \
  ...
  data.val_files="${ROOT}/rl_data_aug/AIME24_qwen_default_system_no_boxed_train_format.jsonl" \
  ...
  trainer.experiment_name=openr1_original_qwen3_1_7b_eval64 \
  ...
  trainer.default_local_dir="${ROOT}/ckpts/openr1-original-qwen3-1.7b-eval64" \
  trainer.validation_data_dir="${ROOT}/logs/openr1-original-qwen3-1.7b-eval64_validation" \
  trainer.rollout_data_dir="${ROOT}/logs/openr1-original-qwen3-1.7b-eval64_rollout" \
