...
RUN_NAME="dapo-math-100k-qwen3-1.7b-base-reward-lr1e-6-300-steps-wandb"
EXPERIMENT_NAME="dapo_math_100k_qwen3_1_7b_base_reward_lr1e_6_300_steps_wandb"
...
../.venv/bin/python -m verl.trainer.main_ppo \
  ...
  data.train_files="/storage/openpsi/users/zzy/dapo/data/dapo-math-17k-first100k.parquet" \
  ...
  actor_rollout_ref.model.path=/storage/openpsi/models/Qwen__Qwen3-1.7B-base \
